        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-20">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-white/60 font-bold">
              ...
              <li><a href="/services.html" className="hover:text-premium-gold transition-colors">Services</a></li>
              <li><a href="/about.html" className="hover:text-premium-gold transition-colors">About Us</a></li>
              <li><a href="/contact.html" className="hover:text-premium-gold transition-colors">Contact Us</a></li>
            </ul>
          </div>
