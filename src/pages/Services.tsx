...
export default function Services() {
  ...
  const services = [
    ...
    },
    {
      ...
      img: "https://i.ibb.co/8gG2tgrr/top-view-resumes-applicants-magnifying-260nw-2161194169.webp"
    },
    {
      ...
      icon: <Layout className="text-black" size={32} />,
      img: "https://i.ibb.co/n8CvctkQ/registration-online-membership-network-internet-business-technology-concept-104512007.webp"
    },
    {
      ...
      icon: <ImageIcon className="text-black" size={32} />,
      img: "https://i.ibb.co/PGLsYvKm/editable-youtube-video-thumbnail-template-260nw-2533894069.webp"
    }
  ];
