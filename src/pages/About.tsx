...
export default function About() {
  ...
  return (
    <div className="bg-white min-h-screen relative overflow-hidden text-black">
      {/* Floating Decorative Elements */}
      <motion.div 
        animate={{ y: [0, -20, 0], rotate: [0, 10, 0] }}
        transition={{ duration: 5, repeat: Infinity }}
        className="absolute top-20 left-10 opacity-10 text-black"
      >
        <Sparkles size={100} />
      </motion.div>
      <motion.div 
        ...
        className="absolute bottom-20 right-10 opacity-10 text-black"
      >
        <Star size={120} />
      </motion.div>

      {/* About Hero */}
      <section className="py-16 border-b border-black/5 relative z-10">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-gray-700 text-lg leading-relaxed mb-6">
                Founded by <span className="text-black font-bold">Priyanshu Kumar</span>, Walt Designs & Studio is a New Delhi-based creative powerhouse dedicated to redefining digital standards.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {stats.map((s, i) => (
                  <motion.div 
                    ...
                    className="bg-gray-50 border border-gray-200 rounded-2xl p-8 group hover:border-premium-gold/50 transition-all relative overflow-hidden shadow-sm"
                  >
                    ...
                    <p className="text-sm text-gray-500 uppercase tracking-widest font-bold">{s.label}</p>
                  </motion.div>
                ))}
              </div>
            </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((v, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: i * 0.1 }}
                className="bg-gray-50 border border-gray-200 rounded-2xl p-8 text-center group hover:bg-gray-100 transition-all shadow-sm"
              >
                <div className="mb-6 p-4 bg-white rounded-2xl w-fit mx-auto group-hover:bg-premium-gold/20 transition-colors shadow-sm">
                  {v.icon}
                </div>
      ...
      <section className="py-20 bg-gray-50 relative overflow-hidden border-t border-gray-200">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black text-black mb-6 uppercase tracking-tighter">What Our Clients Say</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((t, i) => (
              <motion.div
                ...
                className="bg-white border border-gray-200 p-8 rounded-[2rem] hover:border-premium-gold/20 transition-all group shadow-sm"
              >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="text-black font-bold uppercase tracking-tight">{t.name}</h4>
